      ...
      <div className={styles.main}>
        <div
          className={`${styles.container} ${styles.a_container} ${
            !hiddenState ? styles.is_txl : ''
          } ${!hiddenState ? styles.is_hidden : ''}`}
          id='a-container'
        >
          <form action='' className={styles.form} id='a-form'>
        ...
        <div
          className={`${styles.container} ${styles.b_container} ${
            !hiddenState ? styles.is_txl : ''
          } ${!hiddenState ? styles.is_z200 : ''} ${hiddenState ? styles.is_hidden : ''}`}
          id='b-container'
        >
          <form action='' className={styles.form} id='b-form'>
        ...
        <div
          className={`${styles.switch} ${!hiddenState ? styles.is_txr : ''} ${
            is_gx ? styles.is_gx : ''
          }`}
          id='switch-cnt'
        >
          ...
          <div
            className={`${styles.switch__container} ${!hiddenState ? styles.is_hidden : ''}`}
            id='switch-c1'
            style={{ height: '240px' }}
          >
            <h2 className={`${styles.switch__title}`}>Welcome Back!</h2>
            <p className={styles.switch__description}>
              To keep connected with us please login with your personal info
            </p>
            <button
              className={`${styles.switch__button} ${styles.button} switch-btn`}
          ...
          <div
            ...
            style={{ height: '240px' }}
          >
            <h2 className={`${styles.switch__title}`}>Hello Friend!</h2>
            <p className={styles.switch__description}>
